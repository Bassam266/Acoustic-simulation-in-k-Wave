...
This simulation will help us to know the influence of the different acoustic impedances using different polymer layers on the time of flight and link that with the ultrasound frequency. 
